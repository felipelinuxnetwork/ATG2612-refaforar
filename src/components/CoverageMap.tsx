...
export const CoverageMap: React.FC = () => {
  return (
    <section id="cobertura" className="py-24 bg-slate-100 dark:bg-slate-950 text-slate-900 dark:text-slate-100 border-b border-slate-200 dark:border-slate-800 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute inset-0 -z-20 overflow-hidden pointer-events-none opacity-20 dark:opacity-30">
        ...
        />
        <div className="absolute inset-0 bg-slate-100/80 dark:bg-slate-950/80" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 space-y-6 flex flex-col justify-between">
            ...
            {/* Headquarters Card */}
            <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-6 sm:p-7 border border-slate-200/90 dark:border-slate-800 space-y-5 shadow-xl">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-blue-600/10 dark:bg-blue-500/20 border border-blue-500/20 text-blue-600 dark:text-blue-400 flex items-center justify-center shrink-0 mt-1 shadow-sm">
                  <MapPin className="w-6 h-6" />
                </div>
                <div>
                  <h3 className="text-lg font-bold text-slate-900 dark:text-white">Sede Central Moema</h3>
                  <p className="text-sm text-slate-700 dark:text-slate-300 font-semibold mt-0.5">{companyData.address.full}</p>
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Av. Jurucê, 898 - Moema - São Paulo - SP</p>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-6 border border-slate-200/90 dark:border-slate-800 space-y-3 shadow-md">
          ...
          <div className="lg:col-span-7 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-2xl min-h-[400px] flex flex-col">
            <div className="bg-slate-50 dark:bg-slate-900/90 px-4 py-3 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-red-500" />
                <div className="w-3 h-3 rounded-full bg-yellow-500" />
                <div className="w-3 h-3 rounded-full bg-emerald-500" />
                <span className="text-xs font-bold text-slate-700 dark:text-slate-300 ml-2">Moema, São Paulo • Base Operacional</span>
              </div>
              <span className="text-[11px] text-emerald-700 dark:text-emerald-300 bg-emerald-100 dark:bg-emerald-950/80 border border-emerald-200 dark:border-emerald-800/60 px-2.5 py-0.5 rounded-full font-bold flex items-center gap-1.5">
            ...
            <div className="flex-1 w-full min-h-[380px] sm:min-h-[460px]">
              <iframe
                ...
                className="w-full h-full dark:invert-[0.9] dark:hue-rotate-180 dark:contrast-125 transition-all duration-300"
              />
            </div>
          </div>
