...
export const AboutSection: React.FC = () => {
  return (
    <section id="sobre" className="py-24 bg-slate-50 text-slate-900 border-b border-slate-200 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden border-4 border-white shadow-2xl bg-white group">
              ...
              <div className="absolute bottom-6 left-6 right-6 p-5 rounded-2xl bg-white/95 backdrop-blur-md border border-slate-200 shadow-2xl flex items-center justify-between">
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    <h4 className="text-slate-900 font-bold text-sm">Anos de Tradição</h4>
                    <p className="text-xs text-slate-500 font-medium">Atendimento em toda a Grande SP</p>
                  </div>
                </div>
          ...
          >
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-100 border border-blue-200 text-blue-700 text-xs font-bold uppercase tracking-wider">
              <Award className="w-4 h-4 text-blue-600" /> Quem Somos
            </div>
            ...
            <div className="pt-4 flex flex-col sm:flex-row gap-3">
              ...
              <a
                ...
                className="py-3.5 px-6 rounded-xl font-bold text-slate-700 bg-white hover:bg-slate-100 border border-slate-300 flex items-center justify-center gap-2 transition-colors text-sm shadow-sm"
              >
